(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();const N="modulepreload",U=function(e){return"/kiosk/"+e},f={},_=function(t,s,i){let n=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=o?.nonce||o?.getAttribute("nonce");n=Promise.allSettled(s.map(l=>{if(l=U(l),l in f)return;f[l]=!0;const g=l.endsWith(".css"),E=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${E}`))return;const u=document.createElement("link");if(u.rel=g?"stylesheet":N,g||(u.as="script"),u.crossOrigin="",u.href=l,r&&u.setAttribute("nonce",r),document.head.appendChild(u),g)return new Promise((T,M)=>{u.addEventListener("load",T),u.addEventListener("error",()=>M(new Error(`Unable to preload CSS for ${l}`)))})}))}function a(o){const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o}return n.then(o=>{for(const r of o||[])r.status==="rejected"&&a(r.reason);return t().catch(a)})},c={caseSharingUrl:"https://case-sharing-564499947017.europe-west3.run.app",pollInterval:5e3,autoArchiveHours:2,staleGpsMinutes:5,hospitalId:(()=>{const e=localStorage.getItem("kiosk_hospital_id");return e===null?"BY-NS-001":e===""?null:e})(),hospitalName:localStorage.getItem("kiosk_hospital_name")||"LMU Klinikum München - Großhadern",googleMapsApiKey:"AIzaSyACBndIj8HD1wwZ4Vw8PDDI0bIe6DoBExI",playAudioAlert:!0,audioAlertVolume:.5,showArchivedCases:!1,maxCasesDisplay:20,theme:"dark"},L=[{id:"BY-NS-001",name:"LMU Klinikum München - Großhadern"},{id:"BY-NS-002",name:"Klinikum Rechts der Isar"},{id:"BY-NS-003",name:"Helios Klinikum München West"},{id:"BY-NS-004",name:"Klinikum Bogenhausen"},{id:"BW-NS-001",name:"Universitätsklinikum Tübingen"},{id:"BW-NS-005",name:"Klinikum Stuttgart - Katharinenhospital"},{id:"BW-NS-003",name:"Universitätsklinikum Freiburg"},{id:"ALL",name:"🌐 All Hospitals (Show All Cases)"}];function B(e){const t=L.find(s=>s.id===e);t&&(e==="ALL"?(localStorage.setItem("kiosk_hospital_id",""),localStorage.setItem("kiosk_hospital_name",t.name)):(localStorage.setItem("kiosk_hospital_id",e),localStorage.setItem("kiosk_hospital_name",t.name)),c.hospitalId=e==="ALL"?null:e,c.hospitalName=t.name,window.location.reload())}const m={IMMEDIATE:{color:"#ff4444",icon:"🚨",priority:0},TIME_CRITICAL:{color:"#ff8800",icon:"⏰",priority:1},URGENT:{color:"#ffcc00",icon:"⚠️",priority:2},STANDARD:{color:"#4a90e2",icon:"🏥",priority:3}},P=Object.freeze(Object.defineProperty({__proto__:null,AVAILABLE_HOSPITALS:L,KIOSK_CONFIG:c,URGENCY_CONFIG:m,setHospital:B},Symbol.toStringTag,{value:"Module"}));class R{constructor(){this.baseUrl=c.caseSharingUrl,this.pollInterval=c.pollInterval,this.hospitalId=c.hospitalId,this.intervalId=null,this.cases=new Map,this.onUpdate=null,this.onError=null,this.lastFetchTime=null,this.isConnected=!1}start(t,s){this.onUpdate=t,this.onError=s,this.fetchCases(),this.intervalId=setInterval(()=>{this.fetchCases()},this.pollInterval),console.log("[CaseListener] Started polling every",this.pollInterval,"ms")}stop(){this.intervalId&&(clearInterval(this.intervalId),this.intervalId=null,console.log("[CaseListener] Stopped polling"))}async fetchCases(){try{const t=this.buildFetchUrl(),s=await fetch(t,{method:"GET",headers:{Accept:"application/json"},signal:AbortSignal.timeout(8e3)});if(!s.ok)throw new Error(`HTTP ${s.status}: ${s.statusText}`);const i=await s.json();if(!i.success)throw new Error(i.error||"Failed to fetch cases");this.isConnected=!0,this.lastFetchTime=new Date,this.processCases(i.cases||[]),this.onUpdate&&this.onUpdate({cases:Array.from(this.cases.values()),timestamp:i.timestamp,count:i.count})}catch(t){console.error("[CaseListener] Fetch error:",t),this.isConnected=!1,this.onError&&this.onError(t)}}buildFetchUrl(){let t=`${this.baseUrl}/get-cases`;const s=new URLSearchParams;this.hospitalId&&s.append("hospitalId",this.hospitalId),s.append("status","in_transit");const i=s.toString();return i&&(t+=`?${i}`),t}processCases(t){const s=new Set(this.cases.keys()),i=new Set;t.forEach(n=>{const a=n.id;i.add(a);const o=!this.cases.has(a);this.cases.set(a,{...n,isNew:o,receivedAt:o?new Date:this.cases.get(a).receivedAt}),o&&console.log("[CaseListener] New case:",a,this.getCaseSummary(n))}),s.forEach(n=>{i.has(n)||(console.log("[CaseListener] Case removed:",n),this.cases.delete(n))})}getCaseSummary(t){const s=Math.round((t.results?.ich?.probability||0)*100),i=t.tracking?.duration||"?";return{module:t.moduleType,ich:`${s}%`,eta:`${i} min`,urgency:t.urgency}}getCases(){return Array.from(this.cases.values())}getCase(t){return this.cases.get(t)}markViewed(t){const s=this.cases.get(t);s&&(s.isNew=!1,this.cases.set(t,s))}getStatus(){return{isConnected:this.isConnected,lastFetchTime:this.lastFetchTime,caseCount:this.cases.size,isPolling:this.intervalId!==null}}}const h=new R;function K(e){const t=document.getElementById("casesContainer");if(!t)return;if(!e||e.length===0){t.innerHTML=`
    ...
    `;return}const i=H(e).map(n=>O(n)).join("");t.innerHTML=`
  ...
  `}function k(e){return e>70?"#ff4444":e>50?"#ff8800":e>30?"#ffcc00":"#4a90e2"}function F(e){const t=new Date,s=new Date(e),i=Math.floor((t-s)/1e3);if(i<60)return`${i}s ago`;const n=Math.floor(i/60);return n<60?`${n}m ago`:`${Math.floor(n/60)}h ${n%60}m ago`}function D(e){const t=document.getElementById("caseDetailModal");if(!t)return;const s=t.querySelector(".modal-content");s&&(s.innerHTML=V(e),t.style.display="flex")}function V(e){const{results:t,formData:s,moduleType:i,ambulanceId:n,tracking:a,urgency:o}=e,r=Math.round((t?.ich?.probability||0)*100),l=t?.lvo?Math.round(t.lvo.probability*100):null;return`
          ...
          <div class="risk-display-large">
            ...
            ${l!==null?`
              <div class="risk-item-large">
                ...
                <div class="risk-value-large" style="color: ${y(l)}">${l}%</div>
                <div class="risk-level-large">${b(l)}</div>
              </div>
            `:""}
          </div>
        </div>
  ...
  `}let v=[],d=null;async function w(){console.log("[Kiosk] Initializing...",c),q(),$(),setInterval($,1e3),W(),h.start(e=>G(e),e=>z(e)),J(),console.log("[Kiosk] Initialized successfully")}function G(e){const t=v.length;v=e.cases||[],console.log("[Kiosk] Cases updated:",{count:v.length,previous:t}),K(v),Y(e);const s=v.filter(i=>i.isNew);s.length>0&&t>0&&(A(),Z(),setTimeout(()=>{s.forEach(i=>h.markViewed(i.id))},2e3)),S(!0)}function z(e){if(console.error("[Kiosk] Error:",e),S(!1),v.length===0){const t=document.getElementById("casesContainer");t&&(t.innerHTML=`
